...
public class Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            plot= (String) savedInstanceState.getSerializable("plot");
            date= (String) savedInstanceState.getSerializable("release_date");
            poster= (String) savedInstanceState.getSerializable("poster");
            vote= (String) savedInstanceState.getSerializable("vote_avg");
            update(title, plot, date, vote, poster);
        }
    }
